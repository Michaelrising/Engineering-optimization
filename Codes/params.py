...
parser.add_argument('--filepath', type=str, default=r'../Data/Lot3004.sch', help='file path for the rules')
...
parser.add_argument('--penalty0', type=float, default=20, help='Reward coefficient0 for not exceeding target T')
