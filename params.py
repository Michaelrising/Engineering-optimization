...
parser.add_argument('--filepath', type=str, default=r'./Lot1.sch', help='file path for the rules')
...
parser.add_argument('--mode', type=str, default='all', help='modes calculating the reward, can be: early, resource0/1/2, each, if not specified then use all the penalties ')
...
parser.add_argument('--ppo', type=str, default='linear') # linear or gnn
# useless for main1
...
parser.add_argument('--k_epochs', type=int, default=8, help='update policy for K epochs')
